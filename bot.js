...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = [`${client.guilds.size} Server`,' ESK BOT','Type -help |-support |-invite ',`${client.users.size} Members`,'-invite','By: n3k4a & Hosam | BaronTube'];
    var i = -1;
    var j = 0;
...
client.on("message", message => {
 if (message.content === "-invite") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('© ESK :heart: جميع الحقوق محفوظة 2018 لــبوت')
      .addField('شكرا لك لاستخدامك  ESK', `https://discordapp.com/api/oauth2/authorize?client_id=537945182667276288&permissions=0&scope=bot`)
...
client.on("message", message => {
 if (message.content === "-support") {
  const embed = new Discord.RichEmbed()
      ...
      .setColor("RANDOM")
      .setFooter('© ESK BOT :heart: جميع الحقوق محفوظة 2018 لــبوت')  
      .addField('سيرفر الدعم الفني', ` https://discord.gg/GycXxBM  `)
  message.author.send({embed});
